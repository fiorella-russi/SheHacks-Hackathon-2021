        ...
        if action_choice == 1:
            ...
            if self.balance <= 0:
                ...
                while valid_transfer_amount is False:
                    transfer_amount = int(
                        input("Enter the amount you would like to transfer from Chequings into Savings: $"))
            ...
            print(
                f"\tIn 1 year, your Savings account balance will be {Colours.green}${balance_1_year:.2f}{Colours.ENDC}")
            print(
                f"\tIn 5 years, your Savings account balance will be {Colours.green}${balance_5_year:.2f}{Colours.ENDC}")
            print(
                f"\tIn 10 years, your Savings account balance will be {Colours.green}${balance_10_year:.2f}{Colours.ENDC}")
